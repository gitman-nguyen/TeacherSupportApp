  ...
  server: {
    ...
    headers: {
      'Content-Security-Policy': 
        ...
        "connect-src 'self' http://127.0.0.1:5001 http://localhost:5001 https://www.googleapis.com https://cdn.jsdelivr.net ws:; " +
        "img-src 'self' data: blob: https://lh3.googleusercontent.com; " + 
        "frame-src 'self' https://*.google.com https://drive.google.com; " +
